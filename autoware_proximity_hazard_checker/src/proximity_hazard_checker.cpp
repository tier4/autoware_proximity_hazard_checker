...
{
ProximityHazardChecker::ProximityHazardChecker(
...
ProximityHazardObjects ProximityHazardChecker::process(
...
std::optional<uint8_t> ProximityHazardChecker::bearing_to_sector(double bearing_rad) const
{
...
double ProximityHazardChecker::compute_circumradius(
